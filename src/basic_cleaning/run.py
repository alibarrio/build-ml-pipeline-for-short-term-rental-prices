...
def go(args):
    ...
    logger.info(f"Filtering data by price range: {args.min_price} - {args.max_price}")
    ...
    # Drop outliers based on geolocation (for solving issue with sample2)
    logger.info("Filtering data by geolocation")
